...
const Hero = () => {
  return (
    ...
    className="h-[600px]"
  > 
    <SwiperSlide className='h-[600px] overflow-hidden fondo rounded-md'>
        <Link to='/series/1396'>
    ...
    <SwiperSlide className='h-[600px] overflow-hidden fondo2 rounded-md'>
        <Link to='/series/1399'>
            <div className='cursor-pointer h-full'>
    ...
    <SwiperSlide className='h-[600px] overflow-hidden fondo3 rounded-md'>
